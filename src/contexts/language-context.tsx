...
const translations: Record<Lang, Translations> = {
  en: {
    ...
    galleryHeading: "Full Product Gallery",
    galleryFootnote: "🚧 Website still in building",
    zoomHint: "Scroll, pinch, or double-tap to zoom — drag to pan",
    sliderHint: "Drag or swipe left / right — auto-advances every 7 seconds",
  },
  ar: {
    ...
    findUs: "موقعنا",
    viewAllBtn: "عرض كل المنتجات",
    galleryHeading: "معرض المنتجات الكامل",
    galleryFootnote: "🚧 الموقع لا يزال قيد الإنشاء",
    zoomHint: "مرر أو قرّب بإصبعين أو اضغط مرتين للتكبير — اسحب للتحريك",
    sliderHint: "اسحب يميناً أو يساراً — يتغير تلقائياً كل ٧ ثوانٍ",
  },
  zh: {
    heroTag: "汽车配件",
    heroTitle: "皇家",
    ...
    findUs: "找到我们",
    viewAllBtn: "查看所有产品",
    galleryHeading: "完整产品图库",
    galleryFootnote: "🚧 网站仍在建设中",
    zoomHint: "滚动、双指或双击可缩放 — 拖动可平移",
    sliderHint: "左右滑动 — 每 7 秒自动切换",
  },
};
